...
<details>
<summary style={{ cursor: "pointer", fontWeight: 600 }}>USDC ERC-20 ABI — approve, allowance, balanceOf</summary>
...
<details>
<summary style={{ cursor: "pointer", fontWeight: 600 }}>Market provider ABI — getSupplyRate</summary>
