...
3. **Transfer:** Bitcoiners may transfer loans to and from Surge's credit market. This requires signatures from the Bitcoiner, TSN, and a third party credit provider.
4. **Time-Locked Recovery:** If the system becomes unresponsive or the TSN goes offline, the BTC becomes spendable by the borrower after a pre-set time lock.
